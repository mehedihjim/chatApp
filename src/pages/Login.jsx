    ...
    return (
        <div className='w-full h-screen flex justify-between'>
            <div className="w-1/2 flex flex-col items-center justify-center">
                <div>
                    <h1 className='text-4xl text-[#11175D] font-bold mb-3'>Login to your account!</h1>
                    <div className='mt-[53px] flex flex-col gap-[48px] w-[368px]'>
                        ...
                        <p className='text-center text-sm text-[#03014C]'>Already  have an account ? <Link to="/signup" className='text-[#EA6C00] font-bold hover:text-[#a36f41] duration-500' href="#">Sign In</Link></p>
                    </div>
                </div>
            </div>
            <div className="w-1/2">
                <img src={loginImg} alt="login" className='w-full h-full ml-auto object-cover' />
            </div>
        </div>
    )
}
